...
const PASOS_TOUR_SOCIO = [
  ...
  },
  {
    ...
    badge: 'Comunidad CAR',
    icono: 'beneficios',
    tip: 'Explorá la lista de negocios adheridos y sus promociones vigentes al pie.',
  },
  {
    targetId: 'tour-notificaciones',
    titulo: 'Campanita de Notificaciones',
    descripcion:
      'Enterate al instante de novedades del club, aprobación de transferencias de cuotas, confirmaciones de reservas de instalaciones y avisos importantes.',
    badge: 'Avisos & Alertas',
    icono: 'notificaciones',
    tip: 'Un número rojo te indicará si tenés notificaciones pendientes sin leer.',
  },
  {
    targetId: 'tour-carrito',
    titulo: 'Tu Carrito de Compras',
    descripcion:
      'Reuní acá tus compras de indumentaria de la tienda oficial o entradas para ver partidos en vivo, y pagá todo junto en un solo paso.',
    badge: 'Tienda Oficial',
    icono: 'carrito',
    tip: 'Podés sumar productos mientras navegás la tienda y finalizar el pedido cuando quieras.',
  },
  {
    targetId: 'tour-menu-btn',
    titulo: 'Menú Principal de la Aplicación',
    descripcion:
      'Desde este botón accedés a todas las secciones y servicios del club. ¡Vamos a abrirlo para repasar cada una de ellas!',
    badge: 'Navegación',
    icono: 'menu',
    tip: 'Tocá "Siguiente" para desplegar el menú lateral.',
  },
  {
    targetId: 'tour-item-inicio',
    titulo: '1. Inicio',
    descripcion:
      'Te permite volver a esta pantalla principal en cualquier momento para ver tu carnet digital con código QR dinámico y tus accesos directos.',
    badge: 'Menú · Inicio',
    icono: 'inicio',
    abrirMenu: true,
  ...
  },
  {
    ...
    icono: 'compras',
    abrirMenu: true,
    tip: 'Mostrá tu código de retiro en secretaría cuando vayas a buscar tus prendas.',
  },
  {
